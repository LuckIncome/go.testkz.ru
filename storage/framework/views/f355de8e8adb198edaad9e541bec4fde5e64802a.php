  ...
  <section class="news-page">
    <div class="container">
      ...
      <div class="news-items">
          ...
          <div class="news-item" style=" background-image: url(<?php echo e(\Voyager::image($event->image)); ?>)">
            <div class="new__title">
                <span><?php echo e(date('d/m/Y', strtotime($event->created_at))); ?></span> <br>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jandos\Desktop\OpenServer\domains\go.testkz.ru\resources\views/pages/event/index.blade.php ENDPATH**/ ?>