...
class VoyagerArticleController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $articlesForTag = $article->tag()->get();

        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'allTags', 'articlesForTag'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->updateArticleTag($request, $id);
    ...
    public function store(Request $request)
    {
        ...
        $this->updateArticleTag($request, $data->id);
    ...
    protected function updateArticleTag(Request $request, $id)
    {        
        if ($request->articles) {
